...
public class DrawActiveSiteLegend {
    ...
    public static void main(String argv[]) {
        ...
        if (argv.length != 2)
            oechem.OEThrow.Usage("DrawActiveSiteLegend <receptor> <ligand>");
        ...
        OE2DActiveSiteDisplay adisp = new OE2DActiveSiteDisplay(asite,
                                                    new OE2DActiveSiteDisplayOptions(400.0, 400.0));
