...
public class OESetCrystalSymmetry {

    public static void main(String argv[]) {
        if (argv.length != 1) {
            oechem.OEThrow.Usage("OESetCrystalSymmetry <pdb>");
        }
        ...
        OECrystalSymmetryParams p = new OECrystalSymmetryParams(124.978f, 124.978f, 69.000f, 90.0f, 90.0f, 120.0f, 154, 4);
        if (oebio.OESetCrystalSymmetry(mol, p)) {
