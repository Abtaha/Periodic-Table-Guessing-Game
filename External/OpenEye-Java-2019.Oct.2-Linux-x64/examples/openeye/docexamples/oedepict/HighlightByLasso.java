...
public class HighlightByLasso {
    ...
    public static void main(String argv[]) {
        ...
        {
            OEHighlightByLasso highlight = new OEHighlightByLasso(oechem.getOEBlack());
            highlight.SetColor(oechem.getOEDarkGreen());
            depictMoleculesWithHighlight(smiles, ss, highlight, "OEHighlightByLasso_SetColor");
        }
        {
            OEHighlightByLasso highlight = new OEHighlightByLasso(oechem.getOEBlack());
            OEPen pen = new OEPen(oechem.getOEGreenTint(), oechem.getOEDarkGreen(), OEFill.On, 3.0, OEStipple.ShortDash);
            highlight.SetPen(pen);
            depictMoleculesWithHighlight(smiles, ss, highlight, "OEHighlightByLasso_SetPen");
        }
        {
            OEHighlightByLasso highlight = new OEHighlightByLasso(oechem.getOEDarkGreen());
        ...
        }
        {
            ...
            depictMoleculesWithHighlight(smiles, ss, highlight, "OEHighlightByLasso_SetConsiderAtomLabelBoundingBox");
        }
        {
            OEHighlightByLasso highlight = new OEHighlightByLasso(oechem.getOEDarkGreen());
