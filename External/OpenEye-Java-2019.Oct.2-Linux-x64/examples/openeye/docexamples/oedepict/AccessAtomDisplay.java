...
public class AccessAtomDisplay {
    public static void main(String argv[]) {
        ...
        OEHasAtomicNum pred = new  OEHasAtomicNum(OEElemNo.O);
        for (OEAtomBase atom : mol.GetAtoms(pred)) {
        ...
        for (OE2DAtomDisplay ad : disp.GetAtomDisplays(new OEHasAtomicNum(OEElemNo.O))) {
            if (ad.IsVisible()) {
                // do something
            }
        }
