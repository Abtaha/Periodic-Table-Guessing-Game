...
public class MolPropCSV {

    public static void main(String[] argv) {
        URL fileURL = MolPropCSV.class.getResource("MolPropCSV.txt");
        try {
            OEInterface itf = new OEInterface();
            oechem.OEConfigureFromURL(itf, fileURL);
            oemolprop.OEConfigureFilterParams(itf);

            if (!oechem.OEParseCommandLine(itf, argv, "MolPropCSV")) {
            ...
            oemolprop.OEWritePropertyDataToCSV(ofs, ifs, filter);
