...
public class ComplexCavities { 
    public static void main(String[] args) {  
        if (args.length != 3) {
            oechem.OEThrow.Usage("ComplexCavities <protein> <ligand> <surface>");
        }
        String proteinFile = args[0];
        String ligandFile = args[1];
        String surfaceFile = args[2];

        oemolistream prtfs = new oemolistream(proteinFile);
        ...
        oemolistream ligfs = new oemolistream(ligandFile);
