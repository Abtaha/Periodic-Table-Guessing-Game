...
public class ZapSolv1 {
    ...
    public static void main(String argv[]) {
        if (argv.length != 1) {
            System.err.println("usage: ZapSolv1 <molfile>");
            System.exit(1);
        }
        ...
        while (oechem.OEReadMolecule(ifs, mol)) {
            ...
            System.out.println("  Solv (kcal)         : " + 0.59 * solv);
            System.out.println("  Area (Ang^2)        : " + aval);
            System.out.println("  Total (kcal)        : " + total);
            System.out.println("  Int.Coulombic (kcal): " + 0.59 * coul);
            System.out.println();
        }
        ifs.close();
        area.delete();
