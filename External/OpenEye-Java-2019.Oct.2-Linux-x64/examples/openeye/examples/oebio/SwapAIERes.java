...
public class SwapAIERes {

    private void displayUsage() {
        System.err.println("usage: SwapAIERes <resname> [chain] <resnum> <inmol> <outmol>");
        System.err.println("   SwapAIERes THR A 242 in.pdb out.pdb");
        System.exit(1);
    }
    private void swap(String args[]) {
        ...
        while (oechem.OEReadMolecule(ifs, mol)) {
            ...
            if (!oebio.OESwapAIEResidueAtoms(mol, res))
                System.err.println("Failed to swap "+resName+" "+resNum);
