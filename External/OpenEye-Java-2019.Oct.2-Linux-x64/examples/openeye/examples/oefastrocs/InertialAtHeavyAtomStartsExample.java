...
public class InertialAtHeavyAtomStartsExample {
    public static void main(String argv[]) {
        if(argv.length < 2) {
            oechem.OEThrow.Usage("openeye.examples.oefastrocs.InertialAtHeavyAtomStartsExample <database> [<queries> ... ]");
            System.exit(0);
        }
        ...
        for(int i = 1; i < argv.length; i++) {
            ...
            String ofname = base + "_heavy_results." + ext;
            if(!ofs.open(ofname))
